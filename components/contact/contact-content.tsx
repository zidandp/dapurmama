...
const contactInfo = [
  {
    ...
    link: "https://wa.me/6289639011775",
  ...
  },
  {
    ...
    title: "Instagram",
    value: "@dapurmama",
    link: "https://www.instagram.com/dapurmama1211/",
    color: "text-pink-600",
...
Terima kasih!`;
    ...
    window.open(`https://wa.me/6289639011775?text=${encodedMessage}`, "_blank");
    ...
    <div className="container-custom max-w-4xl">
      <div className="text-center mb-12 animate-fade-in">
        ...
        <p className="text-lg text-muted-foreground">
          Ada pertanyaan atau ingin pesan dessert khusus? Jangan ragu untuk
          menghubungi kami!
        </p>
      </div>
          ...
          <Card className="card-product">
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Jl. Mawar No. 123, Perumahan Indah
                <br />
            ...
            <div className="space-y-4">
              <Card className="card-product">
                <CardContent className="p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Pilih produk di katalog, tambahkan ke keranjang, lalu
              ...
              <Card className="card-product">
                <CardContent className="p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Biasanya 1-2 hari kerja, tergantung jenis dan jumlah
                    pesanan.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="card-product">
                <CardContent className="p-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Ya, kami melayani pengiriman untuk area Jakarta dan
                    sekitarnya.
                  </p>
                </CardContent>
              </Card>
